...
// Función de saneamiento iterativo contra la corrupción de caracteres (UTF-8 / ISO-8859-1)
function limpiar_nombre_multibyte($str) {
...
$userDisplay = limpiar_nombre_multibyte($rawName);
?>
<!DOCTYPE html>
